...
//  protocol via the new serializeFSBall3D() virtual (serializer.h).
//  Registered with FullStateSenderPlayer::factory() at version 20 in
//  fullstatesender.cpp (Step 7, "Protocol/Version Plumbing").
//
//===================================================================
*/
